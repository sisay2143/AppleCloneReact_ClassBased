  ...
  render() {
    ...
    <div className="container">
        ...
        <div className="new-alert">
            <Mycomp time = "new" BrandName = "ipad pro" linkmore = "/learn more" linkorder = "/order" description = "iPad Pro available starting 3.25" price ="Magic Keyboard coming in May" />
